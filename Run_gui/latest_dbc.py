        ...
        if ser.isOpen():
            ...
            if received_data:
                ...
                try:
                    ...
                    log_data("Expected Wheel Speed FR", Expected_Wheel_Speed_FR)
                    log_data("Expected Wheel Speed FL", Expected_Wheel_Speed_FL)
                    log_data("Expected Vehicle Speed", Expected_Vehicle_Speed)
                    ...
                    # Prepend the CAN ID to the encoded data
                    encoded_message_with_id = can_id.to_bytes(2, byteorder='big') + encoded_data
                    ...
                    log_data("Sent Data", encoded_message_with_id.hex())
